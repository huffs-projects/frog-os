lib: {
  frogOsOptions = {
    ...
    theme = lib.mkOption {
      ...
      default = "tokyo-night";
      description = "Theme to use for Frog OS configuration";
    };
    wallpaperPath = lib.mkOption {
      type = lib.types.nullOr lib.types.path;
      default = null;
      description = "Optional path to custom wallpaper image to override theme wallpaper";
    };
      ...
      type = lib.types.submodule {
        options = {
          wallpaper_path = lib.mkOption {
            type = lib.types.nullOr lib.types.path;
            default = null;
            description = "Path to the wallpaper image to extract colors from (for generated themes)";
          };
        };
      };
      default = { };
      description = "Theme overrides for generated themes";
    };
    primary_font = lib.mkOption {
      type = lib.types.str;
      default = "CaskaydiaCove Nerd Font";
      description = "Primary font for terminal and UI";
    };
